  ...
  return (
    <div className="container-fluid p-0">
      ...
      >
        ...
        >
          <h1 className="display-4 fw-bold">StandardRoom</h1>
          <p className="lead mb-0">Perfect for people who want to rest and chilling view from the hotel</p>
        </div>
      </div>
      ...
      <section className="my-5 container">
        <div className="row align-items-center">
            ...
            <div id="dormCarousel" className="carousel slide" data-bs-ride="carousel">
              ...
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src={img27} className="d-block w-100" alt="StandardRoom 1" />
                </div>
                <div className="carousel-item">
                  <img src={img28} className="d-block w-100" alt="StandardRoom 2" />
                </div>
                <div className="carousel-item">
                  <img src={img29} className="d-block w-100" alt="StandardRoom 3" />
                </div>
              </div>
              <button
          ...
          <div className="col-md-6">
            <h2 className="fw-bold mb-4">StandardRoom</h2>
            <p className="text-muted">
            A standard hotel room is the most basic type of accommodation offered by a hotel. It provides essential amenities and comfort for travelers seeking a comfortable and convenient stay.
            </p>
            <ul className="list-unstyled">
              ...
              <li>
                <strong>Amenities:</strong> Shared kitchen, lounge area, high-speed Wi-Fi, Bed and linens, Bed and linens, air conditioning, Safe, Hairdryer
              </li>
              <li>
